  ...
  <div class="container px-6 py-12 mx-auto">
    <div class="grid grid-cols-1 gap-6 sm:grid-cols-2 sm:gap-y-10 lg:grid-cols-4">
      <div class="sm:col-span-2">
        <h1 class="max-w-lg text-xl font-semibold tracking-tight text-gray-800 xl:text-2xl dark:text-white">Subscribe to our newsletter to get update.</h1>
      ...
      <div>
        ...
        $footer_menu_1 = wp_nav_menu([
          ...
          'menu_class' => 'footer-menu-1 flex flex-col items-start mt-5 space-y-2',
          'container' => false,
          'echo' => false,
          'depth'         => 1,
          'fallback_cb'   => false,
          'add_li_class'  => 'block text-gray-600 transition-colors duration-300 dark:text-gray-300 dark:hover:text-blue-400 hover:underline hover:text-blue-500'
        ]);
        ?>
        @if ($footer_menu_1)
          {!! $footer_menu_1 !!}
...
{{--        </div>--}}
      ...
      <div>
        ...
        $footer_menu_2 = wp_nav_menu([
          ...
          'menu_class' => 'footer-menu-2 flex flex-col items-start mt-5 space-y-2',
          'container' => false,
          'echo' => false,
          'depth'         => 1,
          'fallback_cb'   => false,
